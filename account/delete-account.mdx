...
- **PMS credentials** - encrypted credentials and OAuth tokens are removed, whichever connection type you used.
...
- Open **Settings**.
- In the PMS card, click **Delete** (Guesty) or **Disconnect** (OwnerRez).

This removes your credentials, webhooks, and synced properties, but preserves your business models, audit history, and other account-level configuration. You can reconnect anytime.
