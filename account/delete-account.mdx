...
- **Your PMS data** - PX is read-only against your PMS. Nothing in Guesty or OwnerRez is changed by deleting your PX account.
...
- **Export anything you want to keep.** Audit PDFs, CSV exports of reports - download them first. Once the account is deleted, they are gone.
