...
<Frame caption="The Listings tab, sorted by money flagged">
  ![Month-End Close listings](/images/screenshots/month-end-close-listings.png)
</Frame>
...
<Frame caption="Exceptions by severity and money flagged by listing">
  ![Month-End Close analytics](/images/screenshots/month-end-close-analytics.png)
</Frame>
...
<Frame caption="Exceptions by type, money flagged by type, and revenue composition">
  ![Month-End Close analytics by type](/images/screenshots/month-end-close-analytics-types.png)
</Frame>
