...
Click **Download Report** above the results table to export a PDF. See [Export PDF](/audit/export-pdf) for what the PDF contains and how to share it.
...
**Many `CATALOG_EMPTY` findings on OwnerRez.**
You have not confirmed the catalog yet. Open **PMS Configuration** and confirm at least one tax row. Then re-run the audit.

**Many `MISSING_TAX` findings on Airbnb bookings.**
You have not configured Airbnb tax remittance. Open **Tax Configuration** and walk through the wizard.
