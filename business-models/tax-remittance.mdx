...
This is **separate** from Airbnb tax remittance (currently Guesty-only), which lives on the Tax Configuration page and tracks marketplace-collected taxes. Read [Airbnb tax remittance](/tax-configuration/airbnb-remittance) for that.
