...
<Steps>
  ...
  <Step title="Connect your PMS">
    On the **Settings** page, find the **Connect Your PMS** card and pick your provider. Each PMS has a dedicated setup guide:
    ...
    Once connected, the **Integration Status** panel shows a green **Webhooks** row reading *Registered and active*, and your properties are pulled in automatically.

    <Frame caption="Connect Your PMS card with provider options">
      ![Connect Your PMS](/images/screenshots/settings-pms-connection.png)
    </Frame>
  </Step>
