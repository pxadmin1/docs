...
<Note>
  Lodgify is not connectable yet. The flow described below is the planned design - the **PMS Connection** card in Settings currently lists Guesty and OwnerRez only. Use this page to see what credentials to gather and what data PX will read once Lodgify ships.
</Note>

PX Accounting will connect to Lodgify with an API key from your Lodgify account settings.
...
| Tax setup | Read directly from Lodgify |
