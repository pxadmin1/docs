...
OwnerRez has no API to read your tax, surcharge, or commission setup. Instead, the moment you authorize the connection PX:
...
**Reservations (bookings)** - id, property, status, check-in / check-out, guest name and count, channel, confirmation code, currency, totals (amount, paid, balance, refunded, host fees), block flag, cancellation snapshot.
