...
<Frame caption="Selecting OwnerRez on the Connect Your PMS card">
...
2. In the **Connect Your PMS** card, pick **OwnerRez**.
...
OwnerRez redirects you back to PX. The card becomes **OwnerRez Connected**, subtitled *Your OwnerRez account is connected via OAuth*, and the **Integration Status** panel below shows a **Webhooks** row reading *Registered and active*.
...
Open **Settings**, go to the **OwnerRez Connected** card, and click **Disconnect**. Confirm in the dialog. This revokes the OAuth token, unregisters webhooks, and **removes your synced properties**. Your business models, tax configuration, and audit history are account-level and stay in place, and you can reconnect at any time.
