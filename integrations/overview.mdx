...
PX Accounting connects to one PMS at a time. The connection lives on the **Settings** page, in the **Connect Your PMS** card. Pick yours below.

<CardGroup cols={2}>
  <Card title="Connect Guesty" icon="plug" href="/integrations/connect-guesty">
    Paste an integration token from the Guesty Marketplace.
  </Card>
