...
OwnerRez does not expose a configuration API for taxes, surcharges, or commission rates. PX works around this with the **OwnerRez Catalog** - a user-maintained list of tax, fee, and commission rules that audits use as the baseline.
