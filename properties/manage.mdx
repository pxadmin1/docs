...
- **Sync from \[PMS]** - triggers a full re-fetch of your listings from Guesty or OwnerRez. The button label changes to match your active provider.
...
- **Page size** dropdown - 25 / 50 / 100 / 200 per page. Defaults to 25.
...
Click **Sync from Guesty** or **Sync from OwnerRez** to re-fetch your listings from the PMS. Sync is idempotent - running it twice is safe and only updates rows where data changed.
